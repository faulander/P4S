        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(blank=True, default=None, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='newshows.Language')),
                ('network', models.ForeignKey(blank=True, default=None, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='newshows.Network')),
                ...
                ('webchannel', models.ForeignKey(blank=True, default=None, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='newshows.Webchannel')),
            ],
            options={
